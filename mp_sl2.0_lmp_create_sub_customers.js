...
define([
  ...
  function onRequest(context) {
    ...
    userId = 1822062;
    role = 1005;
    var invoicingMethod = ["Full Payment Customer", "Full Payment IM"];
    ...
    if (context.request.method === "GET") {
      ...
      customerDetails += '"firstName": {"stringValue": "' + first_name + '"},';
      customerDetails += '"first_name": {"stringValue": "' + first_name + '"},';
      customerDetails += '"lastName": {"stringValue": "' + last_name + '"},';
      customerDetails += '"last_name": {"stringValue": "' + last_name + '"},';
      //LPO Address Fields
      customerDetails +=
