...
define([
  ...
  function onRequest(context) {
    ...
    if (context.request.method === "GET") {
      ...
      if (!isNullorEmpty(franchiseeNominatedAPID)) {
        //Nominated AP Details
        customerDetails += '"apName": {"stringValue": "' + apName + '"},';
        customerDetails += '"apAddr1": {"stringValue": "' + apAddr1 + '"},';
        customerDetails += '"apStreet": {"stringValue": "' + apStreet + '"},';
        customerDetails += '"apSuburb": {"stringValue": "' + apSuburb + '"},';
        customerDetails += '"apState": {"stringValue": "' + apState + '"},';
        customerDetails +=
          '"apPostcode": {"stringValue": "' + apPostcode + '"},';
        customerDetails +=
          '"apLatitude": {"stringValue": "' + apLatitude + '"},';
        customerDetails +=
