 ...
 * Created on:          2026-06-18 07:01:51
 * Modified on:          2026-06-18 07:01:54
...
define([
  ...
  function onRequest(context) {
    ...
    if (context.request.method === "GET") {
      ...
      var lmpHubJobID = context.request.parameters.job_id;
      var lmpHubRequestID = context.request.parameters.request_id;
      var lmpHubCustomerID = context.request.parameters.customer_id;
